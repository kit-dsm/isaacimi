...
# Add dummy robot
asset_path = "/home/fl2644/KIT/evorobot-isaacsim/dummy.usd" # hardcode the path here for now
add_reference_to_stage(usd_path=asset_path, prim_path="/World/Dummy")
dummy = Articulation(prim_paths_expr="/World/Dummy", name="my_dummy_robot")
...
dummy.set_world_poses(positions=np.array([[3.0, 3.0, 0.0]]) / get_stage_units())
