...
With the ongoing research at the IMI into multi-robot systems in logistical scenarios, a framework for many researchers to quickly create and run simulations was needed. Isaac IMI was built to accomplish two goals:
...
* [Preparing USD assets](getting-started/preparing-assets.md)
* [Running a simulation](getting-started/running-a-simulation.md)
* [Adding custom functionality](getting-started/customization.md)
