...
2. Design your robot in a software of your choice and export it to a `.usd` file. Many [softwares](https://openusd.org/release/usd_products.html) support OpenUSD.
